...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Crestline Clearing & Logistics (U) Ltd | Freight forwarding" },
      { name: "description", content: "Crestline Clearing & Logistics (U) Ltd provides professional customs clearing, freight forwarding, cargo transportation, import and export handling." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Crestline Clearing & Logistics (U) Ltd | Freight forwarding" },
      { property: "og:description", content: "Crestline Clearing & Logistics (U) Ltd provides professional customs clearing, freight forwarding, cargo transportation, import and export handling." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Crestline Clearing & Logistics (U) Ltd | Freight forwarding" },
