...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Crestway Clearing & Logistics (U) Ltd | Freight forwarding" },
      { name: "description", content: "Crestway Clearing & Logistics (U) Ltd provides professional customs clearing, freight forwarding, cargo transportation, import and export handling." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Crestway Clearing & Logistics (U) Ltd | Freight forwarding" },
      { property: "og:description", content: "Crestway Clearing & Logistics (U) Ltd provides professional customs clearing, freight forwarding, cargo transportation, import and export handling." },
